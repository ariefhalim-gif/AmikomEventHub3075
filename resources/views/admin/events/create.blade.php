...
<main class="flex-1 p-6 md:p-10 overflow-y-auto">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-500 font-medium mt-1">Buat acara baru dan atur ketersediaan tiket untuk pengunjung.</p>
    </div>

    <!-- Form Card -->
    <div class="max-w-4xl bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8" x-data="{ imagePreview: null }">
